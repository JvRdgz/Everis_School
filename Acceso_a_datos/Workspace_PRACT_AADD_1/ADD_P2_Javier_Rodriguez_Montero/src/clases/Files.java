...
public class Files {
	...
	static String bbddd_properties = ruta_properties + "bbdd.properties";
	static String persistencia_properties = ruta_properties + "persistencia.properties";
	...
	public static String getBbddd_properties() {
		return bbddd_properties;
	}
	public static String getPersistencia_properties() {
		return persistencia_properties;
	}
