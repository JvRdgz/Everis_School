...
public class Servidor {
	...
	public void conectarServidor() {
		// Seleccionamos la carpeta del servidor que va a estar disponible para
		// compartir
		...
		if (resp == JFileChooser.APPROVE_OPTION) {
			// rellenamos nuestra variable file a traves de la seleccion del cuadro de
			// dialogo
	...
	/*
	 * public static void main(String[] args) { Servidor s = new Servidor();
	 * s.conectarServidor(); }
	 */
