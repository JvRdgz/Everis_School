...
public class FrameCliente extends javax.swing.JFrame {
	...
	public void setVariables(ObjectOutputStream salida, ObjectInputStream entrada, String direSelec, String fichSelec,
			String pathSelec, EstructuraFicheros raiz, EstructuraFicheros nodo) {

		this.salida = salida;
		this.entrada = entrada;
		this.dirSelec = dirSelec;
		this.fichSelec = fichSelec;
		this.pathSelec = "." + File.pathSeparator;
		this.raiz = raiz;
		this.nodo = nodo;
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(pie1).addComponent(pie2).addComponent(cabecera2).addComponent(cabecera1))
								...
								layout.createSequentialGroup()
										...
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(layout.createSequentialGroup().addGroup(layout
														...
														.addComponent(subir).addComponent(Descargar))
														.addGap(69, 69, 69))
												.addGroup(layout.createSequentialGroup().addComponent(salir).addGap(30,
														30, 30)))))));
		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
								.addGap(41, 41, 41).addComponent(cabecera1).addGap(42, 42, 42).addComponent(cabecera2)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(layout.createSequentialGroup().addGap(27, 27, 27)
												.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 247,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(18, 18, 18).addComponent(pie1)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 37,
														Short.MAX_VALUE)
												.addComponent(pie2).addGap(23, 23, 23))
										.addGroup(layout.createSequentialGroup().addGap(53, 53, 53).addComponent(subir)
												.addGap(47, 47, 47).addComponent(Descargar).addGap(48, 48, 48)
												.addComponent(salir).addContainerGap(158, Short.MAX_VALUE)))));
...
//                this.pathSelec = fichero.getPath();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(FrameCliente.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
